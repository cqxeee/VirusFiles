...
if DevAbs:get(Virus.."Abs:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DevAbs:sadd(Virus.."Abs:Mute:Names"..msg.chat_id_, MuteName)
end
...
DevAbs:srem(Virus.."Abs:Mute:Names"..msg.chat_id_, UnMuteName)
end
end
if text == "مسح الاسماء المكتومه" and Constructor(msg) then
DevAbs:del(Virus.."Abs:Mute:Names"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "⌁︙تم مسح الاسماء المكتومه")
end
if text == "الاسماء المكتومه" and Constructor(msg) then
local AllNames = DevAbs:smembers(Virus.."Abs:Mute:Names"..msg.chat_id_)
...
if not Manager(msg) and DevAbs:get(Virus.."Abs:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
VirusName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if VirusName then 
VirusNames = DevAbs:smembers(Virus.."Abs:Mute:Names"..msg.chat_id_) or ""
if VirusNames and VirusNames[1] then 
for i=1,#VirusNames do 
if VirusName:match("(.*)("..VirusNames[i]..")(.*)") then 
...
DevAbs:set(Virus.."Abs:Lock:MuteNames"..msg.chat_id_,true)
end
...
DevAbs:del(Virus.."Abs:Lock:MuteNames"..msg.chat_id_)
end
end
end
